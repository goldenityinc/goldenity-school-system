...
const DEFAULT_BACKEND_URL =
  process.env.SUBJECT_API_BASE_URL ?? process.env.CLASSROOM_API_BASE_URL ?? process.env.EMPLOYEE_API_BASE_URL ?? process.env.CENTRAL_COMMAND_URL ?? process.env.GOLDENITY_ADMIN_CORE_API_URL ?? "https://goldenity-admin-core-api.vercel.app";
...
export async function GET() {
  ...
  return forwardJsonResponse("/subjects", { method: "GET" }, session.tenantId);
}
